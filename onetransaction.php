    ...
    <body>
        ...
        <div class="customercontainer">
            ...
            if($result && $result->num_rows)
            {
                ...
                {
                    echo "<tr><td>".$row["Name"]."</td><td>".$row["Email_id"]."</td><td>".$row["Mobile no"]."</td><td>".$row["Balance_Amount"]."</td><td class='slink'><a class='sbtn' href='transfer.php?id=".$row['Email_id']."'>Transfer Money</a></td></tr>";
             }
             echo "</table>";
            }
             else
